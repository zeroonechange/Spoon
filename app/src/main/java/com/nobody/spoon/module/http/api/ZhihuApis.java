package com.nobody.spoon.module.http.api;


import com.nobody.spoon.module.bean.CommentBean;
import com.nobody.spoon.module.bean.DailyBeforeListBean;
import com.nobody.spoon.module.bean.DailyListBean;
import com.nobody.spoon.module.bean.DetailExtraBean;
import com.nobody.spoon.module.bean.HotListBean;
import com.nobody.spoon.module.bean.SectionChildListBean;
import com.nobody.spoon.module.bean.SectionListBean;
import com.nobody.spoon.module.bean.ThemeChildListBean;
import com.nobody.spoon.module.bean.ThemeListBean;
import com.nobody.spoon.module.bean.WelcomeBean;
import com.nobody.spoon.module.bean.ZhihuDetailBean;
